...
import com.whxx.core.dao.TbCommonConfigMapper;
import com.whxx.core.entity.TbCommonConfig;
import com.whxx.core.service.ITbCommonConfigService;
...
public class TbCommonConfigServiceImpl implements ITbCommonConfigService
{
    ...
    public void insertItem(TbCommonConfig commonConfig) throws Exception
    {
        ...
        TbCommonConfig config = tbCommonConfigMapper.selectOne(new QueryWrapper<TbCommonConfig>().lambda().eq(TbCommonConfig::getKeyName, keyName));
        if (config != null)
        {
