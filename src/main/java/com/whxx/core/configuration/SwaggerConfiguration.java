 ...
 * swagger2配置
 *
 * <p>@ApiModel @ApiModelProperty作用在实体类上 可以描述字段信息</p>
 * <p>@Api 作用在类上</p>
...
//                .globalResponseMessage(RequestMethod.GET, newArrayList(customerResponseMessage()))
//                .globalResponseMessage(RequestMethod.POST, newArrayList(customerResponseMessage()))
                ;
    }
    ...
    private ApiInfo apiInfo()
    {
        return new ApiInfoBuilder()
                .title("swagger2构建rest api文档")
                //联系人
                .contact(new Contact("PH", "https://www.baidu.com", ""))
                .description("描述：The Center Demo")
                .version("1.0")
                .build();
    }
