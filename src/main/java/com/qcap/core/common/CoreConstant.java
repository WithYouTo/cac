...
public class CoreConstant {
    ...
    public static final Integer FAIL_CODE = 1008;
    //组织
    ...
    public static final int EXCEL_FORMAT_ERROR_CODE = 9004;
    
    public static final String EXCEL_FORMAT_ERROR_MSG = "excel数据格式错误";
    
    public static final int EXCEL_ERROR_CODE = 9005;
    
    public static final String EXCEL_ERROR_MSG = "导入数据失败";
