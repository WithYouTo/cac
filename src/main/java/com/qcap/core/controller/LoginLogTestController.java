 ...
 */
@Controller
@RequestMapping("/loginLogtest")
public class LoginLogTestController extends BaseController {
    
	private static Logger logger = LoggerFactory.getLogger(LoginLogTestController.class);
    @Autowired
