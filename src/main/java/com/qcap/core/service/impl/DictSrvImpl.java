...
import static com.qcap.core.factory.MutiStrFactory.MUTI_STR_ID;
import static com.qcap.core.factory.MutiStrFactory.MUTI_STR_KEY;
import static com.qcap.core.factory.MutiStrFactory.MUTI_STR_VALUE;
import static com.qcap.core.factory.MutiStrFactory.parseIdKeyValue;
...
public class DictSrvImpl implements DictSrv {
	...
	public void addDict(String dictName, String dictValues) {
		...
		// 解析dictValues
		List<Map<String, String>> items = parseIdKeyValue(dictValues);
		...
		for (Map<String, String> item : items) {
			...
			String num = item.get(MUTI_STR_ID);
			String name = item.get(MUTI_STR_VALUE);
			String code = item.get(MUTI_STR_KEY);

			List<Dict> list = new ArrayList<Dict>();
			// List<Dict> list = dictMapper.selectListByCode(dict.getId(),
			// code);
