...
public class SftpUtil {
	 ...
	 *            SFTP服务器基础目录
	 * @param filePath
	 *            SFTP服务器文件存放路径。例如分日期存放：/2015/01/01。文件的路径为basePath+filePath
	 * @param filename
	 *            文件保存名
	 * @param input
	 *            输入流
	...
	// * @param filePath
	// SFTP服务器文件存放路径。例如分日期存放：/2015/01/01。文件的路径为basePath+filePath * @param
	// fileType
	...
	// * @return
	// */
	// public boolean uploadImageAndResize(String basePath, String filePath,
	// String storeName, String fileType, InputStream input) {
	// boolean flag = false;
	// try {
	// try {
	// sftp.cd(basePath + filePath);
	...
	public static void main(String[] args) throws Exception {
		SftpUtil ftp = new SftpUtil("sftpuser", "192.168.10.65", 22, "sftpuser");
		ftp.connect();
		...
		// "/2015/01/21", "201709091208495990311",".jpg",
		// FileUtils.openInputStream(new
		// File("/Users/huludawang/Downloads/20170909120849599031.jpg")));
