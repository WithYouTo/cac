...
public class CleaningStandardController {
	...
	//PC查询清洁标准列表主表
	@ResponseBody
	@RequestMapping(value="/listTbAreaStandard",method=RequestMethod.POST)
	public Object selectStandard(@Valid CleaningStandardDto cleaningStandardDto) {
		
		new PageFactory<Map<String, Object>>().defaultPage();
		List<Map<String , Object>>list = this.cleaningStandardSrvImpl.listTbAreaStandard(cleaningStandardDto);
	...
	//PC查询清洁标准列表主表
	@ResponseBody
	@RequestMapping(value="/listTbAreaStandardDetail",method=RequestMethod.POST)
	public Object selectStandardDetail(String standardCode) {
		
		new PageFactory<Map<String, Object>>().defaultPage();
		List<Map<String , Object>>list = this.cleaningStandardSrvImpl.listTbAreaStandardDetail(standardCode);
		PageInfo<Map<String, Object>> pageInfo = new PageInfo<Map<String, Object>>(list);
	...
	public Object addStandard(@Valid CleaningStandardDto cleaningStandardDto,@RequestParam("list") String list) {
		
		return this.cleaningStandardSrvImpl.add(cleaningStandardDto,list);
	}
	...
	//pc管理端增加清洁标准明细
	@ResponseBody
	@RequestMapping(value="/addTbAreaStandardDetail",method=RequestMethod.POST)
	public Object addStandardDetail(@Valid CleaningStandardDetailDto cleaningStandardDetailDto) {
		
		return this.cleaningStandardSrvImpl.addStandardDetail(cleaningStandardDetailDto);
	}
	
	
	//pc管理端修改清洁标准明细
	@ResponseBody
	@RequestMapping(value="/editTbAreaStandardDetail",method=RequestMethod.POST)
	public Object editStandardDetail(@Valid CleaningStandardDetailDto cleaningStandardDetailDto) {
		
		return this.cleaningStandardSrvImpl.editStandardDetail(cleaningStandardDetailDto);
		
	}
	
	@ResponseBody
	@RequestMapping(value="/deleteTbAreaStandardDetail",method=RequestMethod.POST)
	public Object deleteStandardDetail(String standardDetailId) {
		
		return this.cleaningStandardSrvImpl.deleteStandardDetail(standardDetailId);
