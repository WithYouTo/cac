...
public class PubCodeController extends BaseController {
    ...
    */
    ...
    @ResponseBody
    public Object list(@RequestParam(required=false)String configCode,@RequestParam(required=false)String configName) {
    ...
    public Object add(@Valid Tbpubcode pubcode, BindingResult result) {
        ...
        if(null!=pubCodeSrv.selectRepeatCode(param)){
        	ResParams.newInstance(CoreConstant.MANAGER_IMPORT_HAS_ERROR_DATA_CODE, CoreConstant.MANAGER_IMPORT_HAS_ERROR_DATA_MSG, null);
        }
        
        pubCodeSrv.insertPubCode(setCreateEmpAndTime(pubcode));
    ...
    public Object delete(@RequestParam String ids,@RequestParam String codes) {
        ...
        for(int i=0;i<idArr.length;i++) {
        	...
        	if(list.isEmpty()) {
        		...
        		return ResParams.newInstance(CoreConstant.SUCCESS_CODE, "项目代码为"+codeArr[i]+"的通用代码档下还有二级菜单，不允许删除", null);
        	}
    ...
    public Object edit(@Valid Tbpubcode tbpubCode, BindingResult result) {
        ...
        this.pubCodeSrv.updatePubCode(setUpdateEmpAndTime(tbpubCode));
    ...
    */
    ...
    public Object addPubCode01(HttpServletRequest request,HttpServletResponse response) {
        ...
        pubCodeSrv.insertPubCode01(setCreateEmpAndTime(tbpubCode01));
    ...
    public Object editpubCode01(HttpServletRequest request,HttpServletResponse response) {
        ...
        this.pubCodeSrv.updatePubCode01(setUpdateEmpAndTime(tbpubCode01));
        return ResParams.newInstance(CoreConstant.SUCCESS_CODE, CoreConstant.EDIT_SUCCESS, null);
    }
